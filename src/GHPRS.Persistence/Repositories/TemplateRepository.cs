...
namespace GHPRS.Persistence.Repositories
{
    public class TemplateRepository : Repository<Template>, ITemplateRepository
    {
        ...
        public void CreateTemplateTable(WorkSheet workSheet)
        {
            ...
            var createScript =
                $"CREATE TABLE If Not Exists uploads.\"{workSheet.TableName}\" ( \"Id\" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1), \"Upload_Batch\" TEXT, {columnsValues} CONSTRAINT \"PK_{workSheet.TableName}\" PRIMARY KEY (\"Id\"));";
