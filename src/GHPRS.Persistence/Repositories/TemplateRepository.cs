    ...
    public class TemplateRepository : Repository<Template>, ITemplateRepository
    {
        ...
        public void CreateTemplateTable(string name, DataTable data)
        {
            ...
            foreach (DataColumn column in data.Columns)
            {
                ...
                columnsValues += $"\"{columnName}\" TEXT, ";
            }
            string createScript = $"CREATE TABLE If Not Exists uploads.\"{name}\" ( \"Id\" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1), {columnsValues} CONSTRAINT \"PK_{name}\" PRIMARY KEY (\"Id\"));";
